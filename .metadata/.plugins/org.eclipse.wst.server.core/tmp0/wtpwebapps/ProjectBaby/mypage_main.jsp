   ...
   <div class="cont1 content clearfix mypage"
      ...
      <div class="boxs box1">
         ...
         <table>
            ...
            <span>   <img src='http://localhost:8097/ProjectBaby/upload/<%=dto.getRealFileName()%>'
                  style="border-radius: 100%;" width='110px' height='110px'> </span>
               <%
                  }
               %>
   ...
   %>
      ...
      <%
            ...
            if (dto.getAuth() == 3 || dto.getAuth() == 9) { //일반회원의 경우
                  ...
                  <span>   <img src='http://localhost:8097/ProjectBaby/upload/<%=sitterDto.getRealFileName() %>'
                        style="border-radius: 100%;" width='130px' height='130px'> </span>
                     <%
                        }
               ...
               <span>   <img src='./image/mainImage.png'
                     ...
                     %>   
                  <span>   <img src='http://localhost:8097/ProjectBaby/upload/<%=userDto.getRealFileName() %>'
                        style="border-radius: 100%;" width='130px' height='130px'> </span>   
