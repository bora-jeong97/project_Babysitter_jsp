...
UPDATE BABY_MEMBER SET user_id='bbb@bbb.bbb' WHERE ID = 'aaa@aaa.aaa';
UPDATE BABY_MEMBER SET Sitter_id='aaa@aaa.aaa' WHERE ID = 'bbb@bbb.bbb';
UPDATE BABY_MEMBER SET AUTH='8' WHERE ID = 'aaa@aaa.aaa';

UPDATE BABY_MEMBER SET sitter_id='' WHERE ID = 'aaa@aaa.aaa';
...
--일반사용자
INSERT INTO BABY_MEMBER(ID, PASSWORD, NAME, AUTH, REGISTER_DATE) VALUES('bbb@bbb.bbb', 'bbb', 'bbb', 3, SYSDATE);
--시터
INSERT INTO BABY_MEMBER(ID, PASSWORD, NAME, AUTH, REGISTER_DATE) VALUES('aaa@aaa.aaa', 'aaa', 'aaa', 4, SYSDATE);
